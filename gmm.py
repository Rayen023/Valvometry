...
print("Moyenne label : " , train_df.groupby("label")[['sequence', 'first_derivative', 'second_derivative']].mean())
print("Std : " , train_df.groupby("label")[['sequence', 'first_derivative', 'second_derivative']].std())
print("Moyenne ID: " , train_df.groupby("ID")[['sequence', 'first_derivative', 'second_derivative']].mean())
print("Std : " , train_df.groupby("ID")[['sequence', 'first_derivative', 'second_derivative']].std())
...
n_components = 2
gm = GaussianMixture(n_components=n_components, covariance_type='diag', n_init=32, random_state=0, max_iter = 250)
